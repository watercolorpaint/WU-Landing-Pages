    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[0 | 1 week | 1] [34.99 | monthly | *]");
                    ...
                    <div class="row">
                    	<div class="col-sm-6 video wow fadeInLeft">
                    		<div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/qDUJMMD0t3Y?autoplay=1&amp;rel=0&amp;showinfo=0&amp;wmode=opaque" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen=""></iframe>
                        	</div>
                            <p style="font-size: 16px;"><strong>Free sample: how to paint a snowy tree</strong></p>
                        </div>
                        <div class="col-sm-6 text wow fadeInUp">
                        	<div class="logo">
                        		<h1>Offer Activated…</h1>
                        	</div>
                            <h2 class="hero">Here's your special offer to access all 54 video classes instantly for free!</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">FREE - Unlock 54 Classes</a>
                            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    <h2>Are we nuts? "$99.99 worth of watercolor classes for free?"</h2>
	                    <p>Yes, we're taking a big risk by giving you everything for free…that's why we're only emailing this to select people like you! Remember, you're protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after 7 days and let your membership auto-renew for $34.99 per month (that's still 65% off the regular price of $99.99 per month, every month!). Your payment information is collected upon sign-up but you aren't charged during your initial 7-day membership. Here's what you get when you sign up to unlock 54 video classes for 7 days, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
