    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[1 | 1 week | 1] [29.99 | monthly | *]");
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Your free trial is being processed &amp; we'll email it to you in 2-3 days. Hate waiting? Here's a 1-TIME OFFER to access all 46 video classes instantly for $1!</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $1 - Unlock 46 Classes For 7 Days</a>
                            </div>
                            <strong>Videos worth $89.99! Payment form should pop up on click</strong>
                        </div>
                    </div>
                </div>
            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    <h2>Are we nuts? "Pay $1 for $89.99 worth of watercolor classes?"</h2>
	                    <p>Yes, we're taking a big risk with this offer…that's why we're only presenting it once! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after 7 days and let your membership auto-renew for $29.99 per month (that's 66% off the regular price of $89.99 per month!). Here's what you get when you spend $1 to unlock 46 video classes for 7 days, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a grandma-friendly website packed with 21+ hours of video classes</h2>
