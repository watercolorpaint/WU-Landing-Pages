    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[34.99 | monthly | *]");
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Here's your special offer to access all 53 video classes instantly for 65% off!</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $34.99 - 53 Classes for 30 Days</a>
                            </div>
                            <p>Was $99.99, so 65% off! Payment form should pop up on click</p>
                        </div>
                    </div>
                </div>
            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    <h2>We nuts? &quot;$34.99 for $99.99 worth of watercolor classes?&quot;</h2>
	                    <p>Yes, we're taking a big risk by slashing 65% off our regular price…that's why we're only emailing it to select people like you! You may ask, "What's the catch?" No catch. No hidden fees. Membership auto-renews for $34.99 per month, so you're protected from price increases and continue enjoying 65% off the regular price of $99.99 per month, every month! Here's what you get when you spend $34.99 to unlock 53 video classes for 30 days, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a dead-simple website packed with 30+ hours of video classes. Just sign in &amp; click play!</h2>
