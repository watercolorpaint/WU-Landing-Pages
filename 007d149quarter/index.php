    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[0 | 1 week | 1] [149.99 | 3 months | *]");
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">FREE - Unlock <?php echo $vclasses; ?> Classes</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        ...
                        <p>Yes, we're taking a big risk by giving you everything for free…that's why we're only emailing this to select people like you! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after your 1st <?php echo str_replace('-',' ', $access_for); ?> and let your membership auto-renew for $149.99 every 3 months (that's still 66% off the regular price of $<?php echo $price; ?> every 3 months!). Your payment information is collected upon sign-up but you aren't charged during your 1st <?php echo str_replace('-',' ', $access_for); ?>. Remember, you're also protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! Here's what you get when you sign up to unlock <?php echo $vclasses; ?> video classes for your 1st <?php echo str_replace('-',' ', $access_for); ?>, all taught by our award-winning watercolorists…</p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6 faq-box wow fadeInLeft">
                        ...
                        <div class="single-faq">
                            ...
                            <span><i class="fa fa-plus"></i></span>
                            <div class="single-faq-text">
                          <p>We collect your payment information but we don't charge you upon sign-up! We accept nearly every payment option: VISA, Mastercard, American Express, Discover, PayPal, Amazon Payments, Bitcoin and Dwolla. After signing up, you can immediately begin watching every Watercolor University video class for <?php echo str_replace('-',' ', $access_for); ?>, no restrictions. After your <?php echo str_replace('-',' ', $access_for); ?>, your membership auto-renews at $149.99 every 3 months (which is 66% off our regular price of $<?php echo $price; ?> every 3 months) and you will be charged. Self-cancel anytime by logging in or contacting us at webmaster@watercolorpainting.com.</p>
                            </div>
                        </div>
                        <div class="single-faq">
