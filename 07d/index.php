            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        ...
                        <p>Yes, we're taking a big risk by giving you everything for free…that's why we're only emailing this to select people like you! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after your 1st <?php echo $access_for; ?> and let your membership auto-renew for $34.99 per month (that's still 65% off the regular price of $<?php echo $price; ?> per month, every month!). Your payment information is collected upon sign-up but you aren't charged during your 1st <?php echo $access_for; ?>. Remember, you're also protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! Here's what you get when you sign up to unlock <?php echo $vclasses; ?> video classes for your 1st <?php echo $access_for; ?>, all taught by our award-winning watercolorists…</p>
                    </div>
                </div>
                <div class="row">
