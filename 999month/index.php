                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <span style="font-size: 16px;"><strong>Videos worth $<?php echo $reg_price; ?>! Sign-up form should pop up on click<br />For 24/7 customer service, call (888) 881-2542</strong></span>
                        </div>
                    </div>
                </div>
            </div>
