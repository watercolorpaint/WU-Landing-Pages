...
<html lang="en">
    ...
    <head>
        ...
        <!-- Facebook Conversion Code for Signed Up For Email Course -->
        <script>(function() {
        ...
        window._fbq.push(['track', '6053483150625', {'value':'0.01','currency':'USD'}]);
        </script>
        <noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6053483150625&amp;cd[value]=0.01&amp;cd[currency]=USD&amp;noscript=1" /></noscript>
    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Your 3-day course is being processed &amp; we'll email it to you in 3 days. Hate waiting? Here's a 1-TIME OFFER to access all 54 video classes instantly for $1!</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $1 - Unlock 54 Classes</a>
                            </div>
                            <span style="font-size: 16px;"><strong>Videos worth $99.99! Payment form should pop up on click</strong></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        ...
                        <p>Yes, we're taking a big risk by slashing so much off our regular price…that's why we're only sharing it with Facebook users like you! Remember, your purchase is protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after 7 days and let your membership auto-renew for $34.99 per month (that's still 65% off the regular price of $99.99 per month, every month!). Here's what you get when you spend $1 to unlock 54 video classes for 7 days, all taught by our award-winning watercolorists…</p>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 single-feature section-description wow fadeIn">
                        <h2>We're Watercolor University: a dead-simple website packed with 31+ hours of video classes</h2>
                        ...
                        <div class="single-faq">
                          ...
                          <p>All payments are handled by Tinypass, which powers transactions for big-name brands like Esquire and Cosmopolitan. We figure if Tinypass is good enough for them, it’s good enough for us. We actually never see your payment information, so we can’t leak it even if we were forced to.</p>
                                ...
                                <div class="single-faq">
                                    ...
                                    <span><i class="fa fa-plus"></i></span>
                                    <div class="single-faq-text">
                                        <p>Videos will lock up so you can no longer watch them. To regain unlimited views, you can buy again; either another 1-time payment or a month-to-month/yearly subscription. Your choice.</p>
                                    </div>
                                </div>
                                <div class="single-faq">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 screenshots section-description wow fadeIn">
                        ...
                        <p>
                            Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 9 here.
                        </p>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="features-container section-container">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        <h2>Preview some of our most popular classes</h2>
                        <p>How to paint 8 common trees, stroke by stroke, so you can follow along and get results fast.</p>
                        <p>How to paint colorful, stunning sunsets using just your imagination.</p>
                        <p>How to paint a dramatic, stormy sky using a special twist to the common wet-on-wet technique.</p>
                        <p>How to paint a dog portrait, which focuses on techniques for painting realistic fur.</p>
                        <p>How to mix crayons and other waxes with your watercolor paint for special effects.</p>
                        <p>How to paint a classic still-life of tulips (and how to paint glass).</p>
                        <p>How to paint a foggy landscape using techniques like negative painting and value control.</p>
                        <p>How to paint a classic color portrait from a black-and-white photo of a former president.</p>
                    </div>
                </div>
            </div>
        </div>
