    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[0 | 14 days | 1] [149.99 | 99999 months | *]");
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">90% off! Here's your introductory offer to save $1800 and unlock all 81 current video classes (and all future classes) FOREVER with a 1-time payment. No subscription</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Buy Now - $199.99</a>
                            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    <h2>No more monthly charges of $149.99. New 1-time payment option, available now at 90% off.</h2>
	                    <p>Look, this introductory offer is only being emailed to select people like you! Now a 1-time payment unlocks every current &amp; future video class, forever (new classes are added each month). Before, $199.99 would only get you 2 months of access—now, the same price gives you lifetime access. You will never need to pay again. Remember, you're protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you won't ask for a refund. Here's what you get when you sign up to unlock every class, forever, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
                	<div class="col-sm-4 features-box wow fadeInUp">
	                    ...
	                    <p>We already have 81 video classes (over 81 hours of video) and we're adding new classes each month with no plans of stopping. Reference photos, initial sketches and list of materials included for relevant classes.</p>
                    </div>
