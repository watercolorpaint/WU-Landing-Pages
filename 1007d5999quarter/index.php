    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[1 | 1 week | 1] [59.99 | 3 months | *]");
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        ...
                        <p>Yes, we're taking a big risk by slashing so much off our regular price…that's why we're only emailing it to select people like you! Remember, your purchase is protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after your 1st <?php echo str_replace('-',' ', $access_for); ?> and let your membership auto-renew for $<?php echo $unlock_in; ?> per month (that's still <?php echo $discount; ?>% off the regular price of $<?php echo $price; ?> per month, every month!). Get all this when you pay $<?php echo $unlock_in; ?> to unlock <?php echo $vclasses; ?> video classes for your 1st <?php echo str_replace('-',' ', $access_for); ?>, all taught by our award-winning watercolorists…</p>
                    </div>
                </div>
                <div class="row">
