                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 video wow fadeInLeft">
                            ...
                            <p style="font-size: 16px;"><strong>Free preview: how to paint a night-time cityscape</strong></p>
                        </div>
                        <div class="col-sm-6 text wow fadeInUp">
                            <div class="logo">
                                <h1>Sale Activated…</h1>
                            </div>
                            <h2 class="hero">Here's your special offer to access all 75 video classes instantly for $1! Save $98.99</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $1 - Unlock 75 Classes</a>
                            </div>
