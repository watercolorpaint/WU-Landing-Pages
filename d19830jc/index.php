    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("2.99", "10 days");
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Like watercolor? Here's a 1-TIME OFFER for you while Day 1 of your 3-Day Email Course is sent to your inbox.</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Buy 45 Video Classes For $2.99</a>
                            </div>
                            <em>Videos worth $89.99! Payment form should pop up on click</em>
                        </div>
                    </div>
                </div>
            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    <h2>Are we nuts? Pay $2.99 for $89.99 worth of watercolor classes?</h2>
	                    <p>We're taking a big risk. You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll like our online classes so much you'll return to buy more. Here's what you get when you spend $2.99 to unlock 45 video classes for 10 days, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
	        ...
	        <div class="container">
	            <div class="row">
                            <div class="col-sm-7 footer-copyright">
                            	&copy; Copyright 2014-15. WatercolorPainting.com
                            </div>
	            </div>
	        </div>
        </footer>
