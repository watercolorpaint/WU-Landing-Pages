    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[2 | 1 week | 1] [34.99 | monthly | *]");
                    ...
                    <div class="row">
                        <div class="col-sm-6 video wow fadeInLeft">
                            <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/_AAbdDPelno?autoplay=1&amp;rel=0&amp;showinfo=0&amp;wmode=opaque" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen=""></iframe>
                            </div>
                            <p style="font-size: 16px;"><strong>Sneak-preview: How to paint a scene involving a forest, a wharf, and surrounding detail</strong></p>
                        </div>
                        <div class="col-sm-6 text wow fadeInUp">
                            <div class="logo">
                                <h1>Sale Activated…</h1>
                            </div>
                            <h2 class="hero">Here's your special offer to access all 54 video classes instantly for $2! Save $97.99</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $2 - Unlock 54 Classes</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        <h2>We nuts? "Pay $2 for $99.99 worth of watercolor classes?"</h2>
                        <p>Yes, we're taking a big risk by slashing $97.99 off our regular price…that's why we're only emailing it to select people like you! Remember, your purchase is protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after 7 days and let your membership auto-renew for $34.99 per month (that's still 65% off the regular price of $99.99 per month, every month!). Here's what you get when you spend $2 to unlock 54 video classes for 7 days, all taught by our award-winning watercolorists…</p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 faq-box wow fadeInUp">
                        ...
                        <div class="single-faq">
                            ...
                            <span><i class="fa fa-plus"></i></span>
                            <div class="single-faq-text">
                                <p>If you can watch videos on websites, you can watch all the videos on Watercolor University. We use HTML5 video players, which means we support nearly every Internet-connected device on the planet, including Apple’s iOS devices and Android devices. Flash is optional and not required.</p>
                            </div>
                        </div>
                        <div class="single-faq">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 screenshots section-description wow fadeIn">
                        ...
                        <p>
                            Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 15 out of 54 here.
                        </p>
                    </div>
                </div>
                <div class="row">
