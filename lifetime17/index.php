                ...
                <div class="container">
                    <div class="row">
                    	<div class="col-sm-6 video wow fadeInLeft">
                            ...
                            <p style="font-size: 17px;"><strong>A video tour of Watercolor University</strong></p>
                        </div>
                        <div class="col-sm-6 text wow fadeInUp">
                        	<div class="logo">
                        		<h1>Sale Activated…</h1>
                        	</div>
                            <h2 class="hero">60% off! Here's your introductory offer to save $1200 and unlock all 73 current video classes (and all future classes) FOREVER with a 1-time payment. No subscription</h2>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
                	<div class="col-sm-4 features-box wow fadeInUp">
	                    ...
	                    <p>We already have 73 video classes (over 69 hours of video) and we're adding new classes each month with no plans of stopping. Reference photos, initial sketches and list of materials included for relevant classes.</p>
                    </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a dead-simple website packed with 69+ hours of video classes</h2>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 screenshots section-description wow fadeIn">
	                    ...
	                    <p>
	                    	Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 9 out of 73 here.
	                    </p>
	                </div>
	            </div>
	   <div class="row">
