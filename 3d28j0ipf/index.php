                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Your 3-day course is being processed &amp; we'll email it to you in 3 days. Hate waiting? Here's a 1-TIME OFFER to access all 56 video classes instantly for $2.99!</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $2.99 - Unlock 56 Classes</a>
                            </div>
                            <strong>Videos worth $99.99! Payment form should pop up on click</strong>
                        </div>
                    </div>
                </div>
            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a dead-simple website packed with 35+ hours of video classes</h2>
	            ...
	            <div class="row">
	            	<div class="col-sm-6 faq-box wow fadeInLeft">
	                    <div class="single-faq">
		                 ...
		                 <ol>
                                                ...
                                                <li>We’re always working on bringing you new videos. Videos take time, especially watercolor videos. Even the best artists don’t paint everything perfectly the first time (especially on camera), which means we need to shoot again and again. We’ve been adding 2-4 new video classes each month.</li>
	                ...
	                <div class="col-sm-6 faq-box wow fadeInUp">
	                    ...
	                    <div class="single-faq">
	                    	...
	                    	<span><i class="fa fa-plus"></i></span>
	                    	<div class="single-faq-text">
		                    	<p>If you can watch YouTube, you can watch all the videos on Watercolor University. We use HTML5 video players, which means we support nearly every Internet-connected device on the planet, including Apple’s iOS devices and Android devices. Flash is optional and not required.</p>
	                    	</div>
	                    </div>
	                    <div class="single-faq">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 screenshots section-description wow fadeIn">
	                    ...
	                    <p>
	                    	Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 24 out of 56 here.
	                    </p>
	                </div>
	            </div>
	            <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/10.jpg" alt="Lake Scene" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInDown">
                        <img src="assets/img/screenshots/11.jpg" alt="Animal Portraits" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/12.jpg" alt="Still Life Arrangement" >
                    </div>
                </div>
                 <div class="row">
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/13.jpg" alt="Crashing Waves" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInDown">
                        <img src="assets/img/screenshots/14.jpg" alt="Abstract Portrait" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/15.jpg" alt="Wax Resists" >
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/16.jpg" alt="Crashing Waves" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInDown">
                        <img src="assets/img/screenshots/17.jpg" alt="Abstract Portrait" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/18.jpg" alt="Wax Resists" >
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/19.jpg" alt="Crashing Waves" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInDown">
                        <img src="assets/img/screenshots/20.jpg" alt="Abstract Portrait" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/21.jpg" alt="Wax Resists" >
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/22.jpg" alt="Crashing Waves" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInDown">
                        <img src="assets/img/screenshots/23.jpg" alt="Abstract Portrait" >
                    </div>
                    <div class="col-sm-4 screenshot-box wow fadeInUp">
                        <img src="assets/img/screenshots/24.jpg" alt="Wax Resists" >
                    </div>
                </div>
	        </div>
        </div>
