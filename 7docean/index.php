                    ...
                    <div class="row">
                    	<div class="col-sm-6 video wow fadeInLeft">
                    		<div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/uBcA4Eb_Bbs?autoplay=1&amp;rel=0&amp;showinfo=0&amp;wmode=opaque" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen=""></iframe>
                        	</div>
                            <p style="font-size: 16px;"><strong>How to paint the ocean in a classic coastal seascape</strong></p>
                        </div>
