    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[199.99 | yearly | *]");
                ...
                <div class="row">
                    <div class="col-sm-6 faq-box wow fadeInLeft">
                        ...
                        <div class="single-faq">
                            ...
                            <span><i class="fa fa-plus"></i></span>
                            <div class="single-faq-text">
                          <p>We collect your payment information but we don't charge you upon sign-up! We accept nearly every payment option: VISA, Mastercard, American Express, Discover, PayPal, Amazon Payments, Bitcoin and Dwolla. After signing up, you can immediately begin watching every Watercolor University video class for <?php echo str_replace('-',' ', $access_for); ?>, no restrictions. After your <?php echo str_replace('-',' ', $access_for); ?>, your membership auto-renews at $<?php echo $unlock_in; ?> per <?php echo str_replace('-',' ', $access_for); ?> and you will be charged. Self-cancel anytime by logging in or contacting us at webmaster@watercolorpainting.com.</p>
                            </div>
                        </div>
                        <div class="single-faq">
