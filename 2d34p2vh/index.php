                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Here's your offer to access all 77 video classes instantly for $2! Save $97.99</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $2 - Unlock 77 Classes</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 screenshots section-description wow fadeIn">
                        ...
                        <p>
                            Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 15 out of 77 here.
                        </p>
                    </div>
                </div>
                <div class="row">
