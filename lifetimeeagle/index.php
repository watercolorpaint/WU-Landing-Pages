                    ...
                    <div class="row">
                    	<div class="col-sm-6 video wow fadeInLeft">
                    		<div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/Ahke2PDdTZs?autoplay=1&amp;rel=0&amp;showinfo=0&amp;wmode=opaque" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen=""></iframe>
                        	</div>
                            <p style="font-size: 17px;"><strong>Free preview: how to paint a wild eagle</strong></p>
                        </div>
                        <div class="col-sm-6 text wow fadeInUp">
                        	<div class="logo">
                        		<h1>Sale Activated…</h1>
                        	</div>
                            <h2 class="hero">60% off! Here's your introductory offer to save $1200 and unlock all 77 current video classes (and all future classes) FOREVER with a 1-time payment. No subscription</h2>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
                	<div class="col-sm-4 features-box wow fadeInUp">
	                    ...
	                    <p>We already have 77 video classes (over 75 hours of video) and we're adding new classes each month with no plans of stopping. Reference photos, initial sketches and list of materials included for relevant classes.</p>
                    </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a dead-simple website packed with 75+ hours of video classes</h2>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 screenshots section-description wow fadeIn">
	                    ...
	                    <p>
	                    	Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 9 out of 77 here.
	                    </p>
	                </div>
	            </div>
	   <div class="row">
