    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[3 | 1 week | 1] [29.99 | monthly | *]");
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Here's your &quot;Black Friday's Back&quot; offer to access all 48 video classes instantly for $3!</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $3 - Unlock 48 Classes For 7 Days</a>
                            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    <h2>Are we nuts? "Pay $3 for $89.99 worth of watercolor classes?"</h2>
	                    <p>Yes, we're taking a big risk by slashing so much off our regular price…that's why we're only emailing it to select people like you! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after 7 days and let your membership auto-renew for $29.99 per month (that's still 66% off the regular price of $89.99 per month, every month!). Here's what you get when you spend $3 to unlock 48 video classes for 7 days, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a grandma-friendly website packed with 23+ hours of video classes</h2>
