    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("1", "10 days");
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Buy 45 Video Classes For $1</a>
                            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    ...
	                    <p>We're taking a big risk. You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll like our online classes so much you'll return to buy more. Here's what you get when you spend $1 to unlock 45 video classes for 10 days, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
