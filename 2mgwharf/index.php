                    ...
                    <div class="row">
                        <div class="col-sm-6 video wow fadeInLeft">
                            <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/2_p6zE6nj-k?modestbranding=1&amp;autoplay=1&amp;rel=0&amp;wmode=opaque" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen=""></iframe>
                            </div>
                            <p style="font-size: 16px;"><strong>Free preview: how to sketch and paint a complicated wharf scene.</strong></p>
                        </div>
                        <div class="col-sm-6 text wow fadeInUp">
                            <div class="logo">
                                <h1>Sale Activated…</h1>
                            </div>
                            <h2 class="hero">Here's your special offer for unlimited access to all 75 video classes for 60 days! Save $129.99 </h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="https://dashboard.tinypass.com/gift?giftId=OF05IZoL" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $69.99 - Gift 75 Classes</a>
                            </div>
                            <span style="font-size: 16px;"><strong>Videos worth $199.98! Save $129.99 today.<br />For 24/7 customer service, call (888) 881-2542</strong></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        <h2>We nuts? "Pay $69.99 for $199.98 worth of classes?"</h2>
                        <p>Yes, we're taking a big risk by slashing so much off our regular price…that's why we're only emailing it to select people like you! Remember, your purchase is protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. Just a 1-time payment unlocks everything. Here's what you get when you spend $69.99 to unlock 75 video classes for 60 days, all taught by our award-winning watercolorists…</p>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 faq-box wow fadeInLeft">
                        ...
                        <div class="single-faq">
                            <h3>How does payment work and what happens when I buy a gift?</h3>
                            <span><i class="fa fa-plus"></i></span>
                            <div class="single-faq-text">
                          <p>We accept nearly every payment option: VISA, Mastercard, American Express, and Discover. During payment, you provide the recipient's email and delivery date so the recipient receives an email with instructions for accessing everything for 60 days starting on any day you choose. Instant delivery, just in time for Christmas.</p>
                            </div>
                        </div>
                        <div class="single-faq">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 screenshots section-description wow fadeIn">
                        ...
                        <p>
                            Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 9 of 75 here.
                        </p>
                    </div>
                </div>
                <div class="row">
