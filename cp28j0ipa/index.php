...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            // Below is for cross-domain tracking to work
            // Get tp object
            tp = window.tp || [];
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Here's your special offer to access all 72 video classes instantly for $1! Save $98.99</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $1 - Unlock 72 Classes</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 screenshots section-description wow fadeIn">
                        ...
                        <p>
                            Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 9 of 72 here.
                        </p>
                    </div>
                </div>
                <div class="row">
