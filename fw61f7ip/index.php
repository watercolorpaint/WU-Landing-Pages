                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Here's your holiday offer to access all 51 video classes instantly for free!</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Unlock 51 Classes For 7 Days</a>
                            </div>
                            <strong>Videos worth $99.99! Sign-up form should pop up on click<br />For 24/7 customer service, call (888) 881-2542</strong>
                        </div>
                    </div>
                </div>
            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a dead-simple website packed with 27+ hours of video classes</h2>
