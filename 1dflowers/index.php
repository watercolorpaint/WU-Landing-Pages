                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 video wow fadeInLeft">
                            ...
                            <p style="font-size: 16px;"><strong>Free preview: how to paint flowers by a window</strong></p>
                        </div>
                        <div class="col-sm-6 text wow fadeInUp">
                            <div class="logo">
                                <h1>Sale Activated…</h1>
                            </div>
                            <h2 class="hero">Here's your special offer to access all 64 video classes instantly for $1! Save $98.99</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $1 - Unlock 64 Classes</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 single-feature section-description wow fadeIn">
                        <h2>We're Watercolor University: a dead-simple website packed with 49+ hours of video classes</h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 screenshots section-description wow fadeIn">
                        ...
                        <p>
                            Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 9 of 64 here.
                        </p>
                    </div>
                </div>
                <div class="row">
