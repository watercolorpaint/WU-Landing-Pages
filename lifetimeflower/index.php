...
<html lang="en">
    ...
    <head>
        ...
        <!-- CSS -->
        <link href='//fonts.googleapis.com/css?family=Cabin:400,710' rel='stylesheet' type='text/css'>
    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("799.99", "999999999 days");
                    ...
                    <div class="row">
                    	<div class="col-sm-6 video wow fadeInLeft">
                    		<div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/s7UOjS_RA8s?autoplay=1&amp;rel=0&amp;showinfo=0&amp;wmode=opaque" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen=""></iframe>
                        	</div>
                            <p style="font-size: 17px;"><strong>Free preview of a Watercolor University video class</strong></p>
                        </div>
                        <div class="col-sm-6 text wow fadeInUp">
                        	<div class="logo">
                        		<h1>Sale Activated…</h1>
                        	</div>
                            <h2 class="hero">60% off! Here's your introductory offer to save $1200 and unlock all 75 current video classes (and all future classes) FOREVER with a 1-time payment. No subscription</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Buy Now - $799.99</a>
                            </div>
                            <span style="font-size: 17px;"><strong>Regular price is $2000. Sign-up form should pop up on click<br />For 24/7 customer service, call (888) 881-2542</strong></span>
                        </div>
                    </div>
                </div>
            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    <h2>No more monthly charges of $99.99. New 1-time payment option, available now at 60% off.</h2>
	                    <p>Look, this introductory offer is only being emailed to select people like you! Now a 1-time payment unlocks every current &amp; future video class, forever (new classes are added each month). Before, $799.99 would only get you 8 months of access—now, the same price gives you lifetime access. You will never need to pay again. Remember, you're protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you won't ask for a refund. Here's what you get when you sign up to unlock every class, forever, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
                	<div class="col-sm-4 features-box wow fadeInUp">
	                    ...
	                    <h3>Infinite Videos</h3>
	                    <p>We already have 75 video classes (over 72 hours of video) and we're adding new classes each month with no plans of stopping. Reference photos, initial sketches and list of materials included for relevant classes.</p>
                    </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a dead-simple website packed with 72+ hours of video classes</h2>
	            ...
	            <div class="row">
	            	<div class="col-sm-6 faq-box wow fadeInLeft">
	                    ...
	                    <div class="single-faq">
	                    	...
	                    	<span><i class="fa fa-plus"></i></span>
	                    	<div class="single-faq-text">
		                  <p>We accept nearly every payment option: VISA, Mastercard, American Express, Discover, PayPal, Amazon Payments, Bitcoin and Dwolla. After signing up, you can immediately begin watching every Watercolor University video class, no restrictions. Self-cancel anytime by logging in or contacting us at webmaster@watercolorpainting.com.</p>
	                    	</div>
	                    </div>
	                    <div class="single-faq">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 screenshots section-description wow fadeIn">
	                    ...
	                    <p>
	                    	Follow along and paint these scenes from start to finish. Many more scenes available. We only had room to show 9 out of 75 here.
	                    </p>
	                </div>
	            </div>
	   <div class="row">
