                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            <div class="logo">
                                <h1>For visitors from EmptyEasel…</h1>
                            </div>
                            <h2 class="hero">Here's your special offer to access all 56 video classes instantly for $3! Save $96.99</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $3 - Unlock 56 Classes</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        ...
                        <p>Yes, we're taking a big risk by slashing so much off our regular price…that's why we're only emailing it to our friends who follow EmptyEasel! Remember, your purchase is protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after 7 days and let your membership auto-renew for $34.99 per month (that's still 65% off the regular price of $99.99 per month, every month!). Here's what you get when you spend $3 to unlock 56 video classes for 7 days, all taught by our award-winning watercolorists…</p>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 single-feature section-description wow fadeIn">
                        <h2>We're Watercolor University: a dead-simple website packed with 34+ hours of video classes</h2>
