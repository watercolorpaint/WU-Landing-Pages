...
<html lang="en">
    ...
    <body>
        ...
        <!-- Google AdWords Conversion Track on click of buy button -->
        <script type="text/javascript">
          /* <![CDATA[ */
          goog_snippet_vars = function() {
            var w = window;
            w.google_conversion_id = 1011816615;
            w.google_conversion_label = "E-STCJypj2cQp7G84gM";
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                $po2 = new TPPriceOption("[1.99 | 1 week | 1] [34.99 | monthly | *]");
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">Here's your special offer to access all 65 video classes instantly for $1.99!</h2>
                            <div class="top-button">
                                <a onclick="goog_report_conversion ('javascript:void(0);'); $mcGoal.processEvent('Started WU Membership Purchase');" id="buy-button" class="button-1" href="javascript:void(0);">Pay $1.99 - Unlock 65 Classes</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 features section-description wow fadeIn">
                        <h2>Are we nuts? "Pay $1.99 for $99.99 worth of watercolor classes?"</h2>
                        <p>Yes, we're taking a big risk by slashing so much off our regular price…that's why we're only sharing it with Gmail users like you! Remember, your purchase is protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! You may ask, "What's the catch?" No catch. No hidden fees. We bet you'll love our online classes so much you'll stay a member after 7 days and let your membership auto-renew for $34.99 per month (that's still 65% off the regular price of $99.99 per month, every month!). Here's what you get when you spend $1.99 to unlock 65 video classes for 7 days, all taught by our award-winning watercolorists…</p>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 single-feature section-description wow fadeIn">
                        <h2>We're Watercolor University: a dead-simple website packed with 51+ hours of video classes</h2>
