                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                            ...
                            <h2 class="hero">60% off! Here's your introductory offer to save $1200 and unlock all 80 current video classes (and all future classes) FOREVER with a 1-time payment. No subscription</h2>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
                	<div class="col-sm-4 features-box wow fadeInUp">
	                    ...
	                    <p>We already have 80 video classes (over 80 hours of video) and we're adding new classes each month with no plans of stopping. Reference photos, initial sketches and list of materials included for relevant classes.</p>
                    </div>
