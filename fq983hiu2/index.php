...
<html lang="en">
    ...
    <head>
        ...
        <!-- VWO and Kissmetrics integration -->
    ...
    <body>
        ...
        <?php
            ...
            if($token->isAccessGranted()) {
                ...
                echo '<div style="text-align:center;line-height:500px;">You have access! Unlock all videos by visiting: <a href="http://lessons.watercolorpainting.com/class-list/" target="_blank">http://lessons.watercolorpainting.com/class-list/</a></div>';
                ...
                $po2 = new TPPriceOption("[24.99 | monthly | *]");
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text wow fadeInUp">
                        	<div class="logo">
                        		<h1>Your Secret Sale…</h1>
                        	</div>
                            <h2 class="hero">Here's your super-secret sale to access everything for 75% off!</h2>
                            <div class="top-button">
                                <a id="buy-button" class="button-1" href="javascript:void(0);" onclick="$mcGoal.processEvent('Started WU Membership Purchase');">Pay $24.99</a>
                            </div>
                            <p>Was $99.99, so 75% off! Payment form should pop up on click</p>
                        </div>
                    </div>
                </div>
            </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    <h2>We nuts? &quot;$24.99 for $99.99 worth of watercolor classes?&quot;</h2>
	                    <p>Yes, we're taking a big risk by slashing 75% off our regular price…that's why we're only emailing it to select people like you! You may ask, "What's the catch?" No catch. No hidden fees. Membership auto-renews for $24.99 per month, so you're protected from price increases and continue enjoying 75% off the regular price of $99.99 per month, every month! Here's what you get when you spend $24.99 to every class for 30 days, all taught by our award-winning watercolorists…</p>
	                </div>
	            </div>
	            <div class="row">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 single-feature section-description wow fadeIn">
	                    <h2>We're Watercolor University: a dead-simple website packed with 36+ hours of video classes. Just sign in &amp; click play!</h2>
	                    <p>Just 1 click to browse a list of all video classes or browse by these class categories: beginner classes, technique classes &amp; step-by-step classes.</p>
	                </div>
	            </div>
	            <div class="row">
	            ...
	            <div class="row">
	                <div class="col-sm-6 single-feature-box single-feature-box-left wow fadeInLeft">
	                    ...
	                    <div class="single-feature-box-text">
	                    	...
	                    	<div class="single-feature-box-text-description">
	                    		Relevant classes include a list of supplies, reference photos, initial sketches, and an image of the finished painting.
	                    	</div>
	                    </div>
	                </div>
	                <div class="col-sm-6 single-feature-box wow fadeInUp">
	            ...
	            <div class="row">
	                ...
	                <div class="col-sm-6 single-feature-box wow fadeInUp">
	                    <div class="single-feature-box-text">
	                    	...
	                    	<div class="single-feature-box-text-description">
	                    		Our teachers have won numerous awards at the regional and national level.
	                    	</div>
	                    </div>
	                    <div class="single-feature-box-text">
	                    	<div class="single-feature-box-text-icon"><i class="fa fa-check"></i></div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 call-to-action section-description wow fadeIn">
	                    ...
	                    <p>
	                    	No risk because you're protected by our 100% Satisfaction Guarantee: love it or your money back, no questions asked! Cancel anytime. Easy-Refund Policy for reclaiming money even if you forget to manage your subscription.
	                    </p>
	                </div>
	            </div>
	            <div class="row">
	            	<div class="col-sm-12 call-to-action-button wow fadeInUp">
	                    <a class="scroll-link button-1" href="#top-content">Back To Top</a>
	                </div>
	            </div>
	        </div>
        </div>
	        ...
	        <div class="container">
	            <div class="row">
                            <div class="col-sm-7 footer-copyright">
                            	&copy; Copyright 2014-2016. WatercolorPainting.com
                            </div>
	            </div>
	        </div>
        </footer>
